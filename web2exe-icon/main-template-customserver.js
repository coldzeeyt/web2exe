...
const extraWindowOptions = __EXTRA_WINDOW_OPTIONS_JSON__;
...
function createWindow(port) {
  ...
  if (options.icon) options.icon = path.join(__dirname, options.icon);
  mainWindow = new BrowserWindow(options);
  if (__START_MAXIMIZED__) mainWindow.maximize();
